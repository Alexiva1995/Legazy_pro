<div class="row mt-1">
    <div class="col-12">
        ...
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="float-right">
                                <img class="float-right" src="{{ asset('assets/img/icon/money.svg') }}" width="110%"
                                    alt="">
                            </div>
                        </div>
            ...
            <div class="col-sm-6 col-12 mt-1">
                <div class="card h-80 p-2" style="background: #1b1b1b;height: 90%;">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="progress ml-2 mb-4 mt-2" style="height: 25px;width: 100%;">
            ...
            <div class="col-12" id="dashboard-analytics">
                    ...
                    <div class="col-sm-6 col-md-4 col-12 mt-1">
                        <div class="card pt-2 " style="background: #1b1b1b; height: 230px;">
                            ...
                            <div class="d-flex align-items-center white mt-2">
                                <button class="btn-darks btn-block" style="boder-color=#D6A83E; position: relative; top: 100%;" onclick="getlink()"><b>LINK DE
