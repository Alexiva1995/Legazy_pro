            ...
            <div class="col-sm-6 col-md-4 col-12 mt-1">
                <div class="card h-90 p-2" style="background: #1b1b1b;">
                    ...
                    <div class="card-dl d-flex align-items-center mt-5">
                        ...
                        @if (Auth::user()->binary_side_register == 'I')
                        <a href="#" class="btn btn-outline-primary padding-button-short bg-primary mt-1 waves-effect waves-light text-white" v-on:click="updateBinarySide('D')">
                            Derecha
                        </a>

                        <a href="#" class="btn btn-outline-warning padding-button-short bg-dark mt-1 waves-effect waves-light text-white" v-on:click="updateBinarySide('I')">
                            Izquierda
                        </a>
                        @else
